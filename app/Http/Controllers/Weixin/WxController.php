...
//        print_r($data);die;
	...
	public function wxlogin(){
        $url = "node.lixiaonitongxue.top/wxlogincode";
        $wxurl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0ed775ffa80afa46&redirect_uri=$url&response_type=code&scope=snsapi_login&state=STATE#wechat_redirect";
